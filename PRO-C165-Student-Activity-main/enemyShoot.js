AFRAME.registerComponent("enemy-bullets", {
    ...
    shootEnemyBullet: function () {
        ...
        for (var i = 0; i < els.length; i++) {
            ...
            var player = document.querySelector("#weapons").object3D
            ...
            enemyBullet.setAttribute("velocity", direction.multiplyScaleArt(10));
            ...
            var playerLife = parseInt(element.getAttribute("next").value)
